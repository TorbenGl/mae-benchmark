#!/bin/bash
# =============================================================================
# Data Locality Benchmark — ViT-Base, batch=512, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=locality-n005-vit_b-bs512
...
#SBATCH --output=logs/locality-n005-vit_b-bs512-%j.out
#SBATCH --error=logs/locality-n005-vit_b-bs512-%j.err
