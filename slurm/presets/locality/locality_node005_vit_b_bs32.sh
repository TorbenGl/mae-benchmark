#!/bin/bash
# =============================================================================
# Data Locality Benchmark — ViT-Base, batch=32, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=locality-n005-vit_b-bs32
...
#SBATCH --output=logs/locality-n005-vit_b-bs32-%j.out
#SBATCH --error=logs/locality-n005-vit_b-bs32-%j.err
