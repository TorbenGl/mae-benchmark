#!/bin/bash
# =============================================================================
# Data Locality Benchmark — ViT-Base, batch=256, node005 (remote storage)
# node005: 32 CPUs, 60 GB RAM, H200 NVL 140 GB
# NOTE: node005 must be undrained before submitting:
#   scontrol update nodename=node005 state=resume
# =============================================================================
#SBATCH --job-name=locality-n005-vit_b-bs256
...
#SBATCH --output=logs/locality-n005-vit_b-bs256-%j.out
#SBATCH --error=logs/locality-n005-vit_b-bs256-%j.err
