#!/bin/bash
# =============================================================================
# Data Locality Benchmark — ViT-Base, batch=128, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=locality-n005-vit_b-bs128
...
#SBATCH --output=logs/locality-n005-vit_b-bs128-%j.out
#SBATCH --error=logs/locality-n005-vit_b-bs128-%j.err
