#!/bin/bash
# =============================================================================
# Data Locality Benchmark — ViT-Base, batch=32, node007 (local storage)
# node007: 16 CPUs, 32 GB RAM, H200 NVL 140 GB
# =============================================================================
#SBATCH --job-name=locality-n007-vit_b-bs32
...
#SBATCH --output=logs/locality-n007-vit_b-bs32-%j.out
#SBATCH --error=logs/locality-n007-vit_b-bs32-%j.err
