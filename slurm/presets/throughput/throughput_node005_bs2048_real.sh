#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=2048, node005 (remote storage), real data
...
# =============================================================================
#SBATCH --job-name=throughput-n005-bs2048-real
...
#SBATCH --output=logs/throughput-n005-bs2048-real-%j.out
#SBATCH --error=logs/throughput-n005-bs2048-real-%j.err
