#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=1024, node007 (local storage), real data
...
# =============================================================================
#SBATCH --job-name=throughput-n007-bs1024-real
...
#SBATCH --output=logs/throughput-n007-bs1024-real-%j.out
#SBATCH --error=logs/throughput-n007-bs1024-real-%j.err
