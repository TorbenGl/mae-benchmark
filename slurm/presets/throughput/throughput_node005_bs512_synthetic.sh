#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=512, node005 (remote storage), synthetic data
# Synthetic mode: random tensors, no disk I/O — pure GPU throughput baseline.
# Compare perf/throughput_imgs_per_sec with the real variant to isolate disk effects.
...
# =============================================================================
#SBATCH --job-name=throughput-n005-bs512-synthetic
...
#SBATCH --output=logs/throughput-n005-bs512-synthetic-%j.out
#SBATCH --error=logs/throughput-n005-bs512-synthetic-%j.err
