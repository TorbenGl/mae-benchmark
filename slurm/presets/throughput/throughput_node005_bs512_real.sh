#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=512, node005 (remote storage), real data
# OOM budget: 40 workers × 4 prefetch × 512 imgs × 0.6 MB = 49 GB prefetch buffer
...
#   node007 (local storage) gives reliable io/disk_read_MB_per_sec readings.
# =============================================================================
#SBATCH --job-name=throughput-n005-bs512-real
...
#SBATCH --output=logs/throughput-n005-bs512-real-%j.out
#SBATCH --error=logs/throughput-n005-bs512-real-%j.err
