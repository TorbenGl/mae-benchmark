#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=512, node007 (local storage), real data
...
# =============================================================================
#SBATCH --job-name=throughput-n007-bs512-real
...
#SBATCH --output=logs/throughput-n007-bs512-real-%j.out
#SBATCH --error=logs/throughput-n007-bs512-real-%j.err
