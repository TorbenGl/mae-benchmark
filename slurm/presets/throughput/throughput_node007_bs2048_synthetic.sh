#!/bin/bash
# =============================================================================
# Throughput Benchmark — ViT-Base, batch=2048, node007 (local storage), synthetic data
...
# =============================================================================
#SBATCH --job-name=throughput-n007-bs2048-synthetic
...
#SBATCH --output=logs/throughput-n007-bs2048-synthetic-%j.out
#SBATCH --error=logs/throughput-n007-bs2048-synthetic-%j.err
