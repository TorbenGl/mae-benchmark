#!/bin/bash
# =============================================================================
# Throughput V2 — ViT-Base, bs=2048, node007 (local storage), LOW config
...
# =============================================================================
#SBATCH --job-name=tv2-n007-bs2048-low
...
#SBATCH --output=logs/tv2-n007-bs2048-low-%j.out
#SBATCH --error=logs/tv2-n007-bs2048-low-%j.err
