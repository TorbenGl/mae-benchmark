#!/bin/bash
# =============================================================================
# Throughput V2 — ViT-Base, bs=512, node007 (local storage), HIGH config
# num_workers=14, prefetch_factor=8
# =============================================================================
#SBATCH --job-name=tv2-n007-bs512-high
...
#SBATCH --output=logs/tv2-n007-bs512-high-%j.out
#SBATCH --error=logs/tv2-n007-bs512-high-%j.err
