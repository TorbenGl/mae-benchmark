#!/bin/bash
# =============================================================================
# Throughput V2 — ViT-Base, bs=512, node005 (remote storage), MID config
# num_workers=14, prefetch_factor=4
# =============================================================================
#SBATCH --job-name=tv2-n005-bs512-mid
...
#SBATCH --output=logs/tv2-n005-bs512-mid-%j.out
#SBATCH --error=logs/tv2-n005-bs512-mid-%j.err
