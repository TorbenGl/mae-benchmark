#!/bin/bash
# =============================================================================
# MAE SLURM Benchmark — ViT-Large, batch=16, H200 MIG (~10 GB slice)
#
...
#SBATCH --output=logs/mae-vit_l-bs16-h200mig-%j.out
#SBATCH --error=logs/mae-vit_l-bs16-h200mig-%j.err
