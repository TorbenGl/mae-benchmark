#!/bin/bash
# =============================================================================
# MAE SLURM Benchmark — ViT-Base, batch=32, H200 MIG (~10 GB slice)
#
# BEFORE SUBMITTING: replace H200_MIG_PARTITION_NAME with your MIG partition.
#   sed -i 's/H200_MIG_PARTITION_NAME/your_partition/' h200_mig_vit_b_bs32.sh
#
...
#SBATCH --output=logs/mae-vit_b-bs32-h200mig-%j.out
#SBATCH --error=logs/mae-vit_b-bs32-h200mig-%j.err
