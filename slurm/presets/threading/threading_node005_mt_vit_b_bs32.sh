#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=32, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=thr-n005-mt-vit_b-bs32
...
#SBATCH --output=logs/thr-n005-mt-vit_b-bs32-%j.out
#SBATCH --error=logs/thr-n005-mt-vit_b-bs32-%j.err
