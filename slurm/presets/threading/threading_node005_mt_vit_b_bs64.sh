#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=64, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=thr-n005-mt-vit_b-bs64
...
#SBATCH --output=logs/thr-n005-mt-vit_b-bs64-%j.out
#SBATCH --error=logs/thr-n005-mt-vit_b-bs64-%j.err
