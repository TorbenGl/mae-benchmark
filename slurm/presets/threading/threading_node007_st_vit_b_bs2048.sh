#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=2048, node007 (local storage)
...
# =============================================================================
#SBATCH --job-name=thr-n007-st-vit_b-bs2048
...
#SBATCH --output=logs/thr-n007-st-vit_b-bs2048-%j.out
#SBATCH --error=logs/thr-n007-st-vit_b-bs2048-%j.err
