#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=1024, node007 (local storage)
# Variant: multi-thread  |  16 workers × 4 threads = 64 cores
# node007: 64 CPUs, 157 GB RAM, H200 NVL 140 GB
# =============================================================================
#SBATCH --job-name=thr-n007-mt-vit_b-bs1024
...
#SBATCH --output=logs/thr-n007-mt-vit_b-bs1024-%j.out
#SBATCH --error=logs/thr-n007-mt-vit_b-bs1024-%j.err
