#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=256, node005 (remote storage)
...
# =============================================================================
#SBATCH --job-name=thr-n005-mt-vit_b-bs256
...
#SBATCH --output=logs/thr-n005-mt-vit_b-bs256-%j.out
#SBATCH --error=logs/thr-n005-mt-vit_b-bs256-%j.err
