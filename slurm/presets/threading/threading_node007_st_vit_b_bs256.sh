#!/bin/bash
# =============================================================================
# Threading Benchmark — ViT-Base, batch=256, node007 (local storage)
# Variant: single-thread  |  56 workers × 1 thread = 56 cores
# node007: 64 CPUs, 157 GB RAM, H200 NVL 140 GB
# =============================================================================
#SBATCH --job-name=thr-n007-st-vit_b-bs256
...
#SBATCH --output=logs/thr-n007-st-vit_b-bs256-%j.out
#SBATCH --error=logs/thr-n007-st-vit_b-bs256-%j.err
