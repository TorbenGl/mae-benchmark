...
# =============================================================================
#SBATCH --job-name=thr-n005-mt-vit_b-bs2048
...
#SBATCH --output=logs/thr-n005-mt-vit_b-bs2048-%j.out
#SBATCH --error=logs/thr-n005-mt-vit_b-bs2048-%j.err
